...
Context
- Enhance the CA3 cluster with ops features: logs/metrics, dashboards, autoscaling, network policies, disruption budgets, chaos drills.
...
```plantuml
@startuml
title CA3 - Ops: Observability + Autoscaling + Security — Iteration from CA3
